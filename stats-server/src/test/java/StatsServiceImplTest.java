...
import ru.practicum.StatsRepositoryEndpointHit;
import ru.practicum.StatsRepositoryViewStats;
...
public class StatsServiceImplTest {
    ...
    @Mock
    StatsRepositoryEndpointHit endpointHitRepo;

    @Mock
    StatsRepositoryViewStats viewStatsRepo;
