...
public class CompilationServiceTest {
    ...
    void createCompilation_Success() {
        Mockito.when(service.addCompilation(Mockito.any(NewCompilationDto.class)))
                .thenReturn(compilationDto);

        CompilationDto dto = service.addCompilation(newCompilationDto);
    ...
    void createCompilation_Error() {
        ...
        try {
            service.addCompilation(newCompilationDto);
    ...
    void updateCompilationInfo_Success() {
        ...
        Mockito.when(service.updateCompilationInfo(Mockito.anyLong(), Mockito.any(UpdateCompilationRequest.class)))
                .thenReturn(compilationDto);

        CompilationDto dto = service.updateCompilationInfo(1L, updateCompilationRequest);
    ...
    void updateCompilationInfo_Error() {
        ...
        try {
            service.updateCompilationInfo(1L, updateCompilationRequest);
        } catch (RuntimeException e) {
