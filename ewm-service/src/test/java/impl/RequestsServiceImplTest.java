...
import ru.practicum.private_api.requests.RequestsServiceImpl;
...
public class RequestsServiceImplTest {
    ...
    void createRequestTest_Success() {
        Request requestSaved = impl.addRequestToEvent(1L, 1L);
    ...
    void createRequestTest_SameUser_Error() {
        assertThrows(ApiError.class, () -> impl.addRequestToEvent(2L, 1L),
    ...
    void cancelRequestTest_Success() {
        ...
        Request request1 = impl.cancelRequest(1L, 1L);
    ...
    void cancelRequestTest_Error() {
        ...
        assertThrows(ApiError.class, () -> impl.cancelRequest(1L, 1L),
    ...
    void getRequestsOfEventTest() {
        ...
        List<Request> requests = impl.getRequestsOfEvent(1L, 1L);
    ...
    void getRequestsByUserTest() {
        ...
        List<Request> requests = impl.getRequestsByUser(1L);
